...
# Outputs: nrf52840-companion.bin and nrf52840-companion.uf2 in project root
set -euo pipefail
...
arm-none-eabi-objcopy -O binary "target/$TARGET/release/$OUT" "$BIN"
